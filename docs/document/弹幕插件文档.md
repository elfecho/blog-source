...
[查看示例](http://Elfecho.cn/document/弹幕插件示例.html)

## 使用

方式一：

[下载](https://github.com/xuzhongpeng/min-barrage/raw/master/example/barrage-example.zip)资源包，解压后引入 barrage.min.js 和 style.css
